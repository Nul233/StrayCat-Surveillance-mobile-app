...
const Profile: React.FC = () => {
  ...
  const [userData, setUserData] = useState<any>({});
   const youtubeVideoUrl = 'https://youtu.be/z97hi5f1CCQ?si=c5W_DOhOdEl4EwE_';
  ...
  const fetchUserData = async () => {
    try {
      ...
      const response = await axios.post('http://localhost/profile.php');
  ...
  return (
    <>
      ...
      <IonContent>
        ...
        <IonButton className="faq" routerLink="/faq">FAQ</IonButton>
